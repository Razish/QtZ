...
XCVAR_DEF( g_antiFakePlayer,					"1",				qfalse,	CVAR_ARCHIVE )
XCVAR_DEF( g_randFix,							"1",				qfalse,	CVAR_ARCHIVE )
XCVAR_DEF( g_delagHitscan,						"1",				qfalse,	CVAR_SERVERINFO )
...
XCVAR_DEF( pm_fixed,							"0",				qtrue,	CVAR_SYSTEMINFO )
XCVAR_DEF( pm_frametime,						"8",				qtrue,	CVAR_SYSTEMINFO )
XCVAR_DEF( pm_snapVec,							"0",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_overbounce,						"0",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_landAccelerateEnable,				"1",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_rampJumpEnable,					"1",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_wallJumpEnable,					"1",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_wallJumpDebounce,					"900",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_bunnyHopEnable,					"1",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_bunnyHopDebounce,					"250",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_doubleJumpEnable,					"1",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_doubleJumpPush,					"130",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_doubleJumpDebounce,				"300",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_accelerate,						"12.0",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_airaccelerate,					"0.75",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_friction,							"10.0",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_jumpVelocity,						"250.0",			qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_airControlEnable,					"1",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_airControl,						"100.0",			qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_airControlStopAccelerate,			"2.5",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_airControlWishspeed,				"15",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
XCVAR_DEF( pm_airControlStrafeAccelerate,		"100",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO )
