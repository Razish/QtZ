...
XCVAR_DEF( pm_fixed,						"0",				qtrue,	CVAR_SYSTEMINFO,								NULL )
...
XCVAR_DEF( pm_doubleJumpPush,				"130",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO,					NULL )
XCVAR_DEF( pm_doubleJumpDebounce,			"300",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO,					NULL )
XCVAR_DEF( pm_accelerate,					"12.0",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO,					NULL )
XCVAR_DEF( pm_airaccelerate,				"0.75",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO,					NULL )
...
XCVAR_DEF( pm_airControlEnable,				"1",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO,					NULL )
...
XCVAR_DEF( pm_airControlStrafeAccelerate,	"100",				qtrue,	CVAR_ARCHIVE|CVAR_SYSTEMINFO,					NULL )
