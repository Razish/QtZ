...
XCVAR_DEF( pm_airControl,					"150.0",			qtrue,		NULL,		CVAR_ARCHIVE|CVAR_SYSTEMINFO,					NULL )
XCVAR_DEF( pm_airControlWishspeed,			"50",				qtrue,		NULL,		CVAR_ARCHIVE|CVAR_SYSTEMINFO,					NULL )
