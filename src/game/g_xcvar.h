...
XCVAR_DEF( sv_gametype,						DEFAULT_GAMETYPE,	qfalse,		NULL,		0,												"Gametype" )
...
XCVAR_DEF( g_scoreUpdateRate,				"1000",				qfalse,		NULL,		CVAR_ARCHIVE,									"Minimum time between sending scoreboard updates" )
...
XCVAR_DEF( pm_airAcceleration,				"1.0",				qtrue,		NULL,		CVAR_SYSTEMINFO,								NULL )
