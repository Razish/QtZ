...
#define CHARACTERISTIC_ATTACK_SKILL					1	//float [0, 1]
//weapon weight file
#define CHARACTERISTIC_WEAPONWEIGHTS				2	//string
//view angle difference to angle change factor
#define CHARACTERISTIC_VIEW_FACTOR					3	//float <0, 1]
//maximum view angle change
#define CHARACTERISTIC_VIEW_MAXCHANGE				4	//float [1, 360]
//reaction time in seconds
#define CHARACTERISTIC_REACTIONTIME					5	//float [0, 5]
//accuracy when aiming
#define CHARACTERISTIC_AIM_ACCURACY					6	//float [0, 1]
//weapon specific aim accuracy
#define CHARACTERISTIC_AIM_ACCURACY_MACHINEGUN		7	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_SHOTGUN			8	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_ROCKETLAUNCHER	9	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_GRENADELAUNCHER	10	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_LIGHTNING		11
#define CHARACTERISTIC_AIM_ACCURACY_PLASMAGUN		12	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_RAILGUN			13
#define CHARACTERISTIC_AIM_ACCURACY_BFG10K			14	//float [0, 1]
//skill when aiming
...
#define CHARACTERISTIC_AIM_SKILL					15	//float [0, 1]
//weapon specific aim skill
#define CHARACTERISTIC_AIM_SKILL_ROCKETLAUNCHER		16	//float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_GRENADELAUNCHER	17	//float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_PLASMAGUN			18	//float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_BFG10K				19	//float [0, 1]
//========================================================
//chat
//========================================================
//file with chats
#define CHARACTERISTIC_CHAT_FILE					20	//string
//name of the chat character
#define CHARACTERISTIC_CHAT_NAME					21	//string
//characters per minute type speed
#define CHARACTERISTIC_CHAT_CPM						22	//integer [1, 4000]
//tendency to insult/praise
#define CHARACTERISTIC_CHAT_INSULT					23	//float [0, 1]
//tendency to chat misc
#define CHARACTERISTIC_CHAT_MISC					24	//float [0, 1]
//tendency to chat at start or end of level
#define CHARACTERISTIC_CHAT_STARTENDLEVEL			25	//float [0, 1]
//tendency to chat entering or exiting the game
#define CHARACTERISTIC_CHAT_ENTEREXITGAME			26	//float [0, 1]
//tendency to chat when killed someone
#define CHARACTERISTIC_CHAT_KILL					27	//float [0, 1]
//tendency to chat when died
#define CHARACTERISTIC_CHAT_DEATH					28	//float [0, 1]
//tendency to chat when enemy suicides
#define CHARACTERISTIC_CHAT_ENEMYSUICIDE			29	//float [0, 1]
//tendency to chat when hit while talking
#define CHARACTERISTIC_CHAT_HITTALKING				30	//float [0, 1]
//tendency to chat when bot was hit but didn't dye
#define CHARACTERISTIC_CHAT_HITNODEATH				31	//float [0, 1]
//tendency to chat when bot hit the enemy but enemy didn't dye
#define CHARACTERISTIC_CHAT_HITNOKILL				32	//float [0, 1]
//tendency to randomly chat
#define CHARACTERISTIC_CHAT_RANDOM					33	//float [0, 1]
//tendency to reply
#define CHARACTERISTIC_CHAT_REPLY					34	//float [0, 1]
//========================================================
//movement
//========================================================
//tendency to crouch
#define CHARACTERISTIC_CROUCHER						35	//float [0, 1]
//tendency to jump
#define CHARACTERISTIC_JUMPER						36	//float [0, 1]
//tendency to walk
#define CHARACTERISTIC_WALKER						37	//float [0, 1]
