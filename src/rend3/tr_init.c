...
void R_Register( void ) 
{
	...
	r_flareWidth	= ri.Cvar_Get( "r_flareWidth", "2.25", CVAR_ARCHIVE );
	r_flareDlights	= ri.Cvar_Get( "r_flareDlights", "1", CVAR_ARCHIVE );
	...
	r_maxpolys = ri.Cvar_Get( "r_maxpolys", va("%d", MAX_POLYS), CVAR_ARCHIVE);
	r_maxpolyverts = ri.Cvar_Get( "r_maxpolyverts", va("%d", MAX_POLYVERTS), CVAR_ARCHIVE);

	//QtZ: Post processing
	r_postprocess_enable				= ri.Cvar_Get( "r_postprocess_enable", "0", CVAR_ARCHIVE );
	r_postprocess_glow					= ri.Cvar_Get( "r_postprocess_glow", "1", CVAR_ARCHIVE );
	r_postprocess_glowMulti				= ri.Cvar_Get( "r_postprocess_glowMulti", "1.25", CVAR_ARCHIVE );
	r_postprocess_glowSat				= ri.Cvar_Get( "r_postprocess_glowSat", "1", CVAR_ARCHIVE );
	r_postprocess_glowSize				= ri.Cvar_Get( "r_postprocess_glowSize", "1024", CVAR_ARCHIVE|CVAR_LATCH ); //latch because framebuffer sizes need to be changed (QTZTODO: runtime framebuffer recreation?)
	r_postprocess_glowBlurStyle			= ri.Cvar_Get( "r_postprocess_glowBlurStyle", "2", CVAR_ARCHIVE );
	r_postprocess_hdr					= ri.Cvar_Get( "r_postprocess_hdr", "1", CVAR_ARCHIVE );
	r_postprocess_hdrOperator			= ri.Cvar_Get( "r_postprocess_hdrOperator", "3", CVAR_ARCHIVE );
	r_postprocess_hdrKeyStyle			= ri.Cvar_Get( "r_postprocess_hdrKeyStyle", "4", CVAR_ARCHIVE );
	r_postprocess_hdrLightAdaptRods		= ri.Cvar_Get( "r_postprocess_hdrLightAdaptRods", "0.6", CVAR_ARCHIVE );
	r_postprocess_hdrLightAdaptCones	= ri.Cvar_Get( "r_postprocess_hdrLightAdaptCones", "0.8", CVAR_ARCHIVE );
	r_postprocess_brightPassThres		= ri.Cvar_Get( "r_postprocess_brightPassThres", "0.5", CVAR_ARCHIVE );
	r_postprocess_brightPassStyle		= ri.Cvar_Get( "r_postprocess_brightPassStyle", "3", CVAR_ARCHIVE );
	r_postprocess_bloom					= ri.Cvar_Get( "r_postprocess_bloom", "1", CVAR_ARCHIVE );
	r_postprocess_bloomMulti			= ri.Cvar_Get( "r_postprocess_bloomMulti", "1", CVAR_ARCHIVE );
	r_postprocess_bloomSat				= ri.Cvar_Get( "r_postprocess_bloomSat", "1", CVAR_ARCHIVE );
	r_postprocess_bloomSceneMulti		= ri.Cvar_Get( "r_postprocess_bloomSceneMulti", "1", CVAR_ARCHIVE );
	r_postprocess_bloomSceneSat			= ri.Cvar_Get( "r_postprocess_bloomSceneSat", "1", CVAR_ARCHIVE );
	r_postprocess_bloomStyle			= ri.Cvar_Get( "r_postprocess_bloomStyle", "2", CVAR_ARCHIVE );
	r_postprocess_bloomSize				= ri.Cvar_Get( "r_postprocess_bloomSize", "512", CVAR_ARCHIVE ); //latch because framebuffer sizes need to be changed (QTZTODO: runtime framebuffer recreation?)
	r_postprocess_bloomSteps			= ri.Cvar_Get( "r_postprocess_bloomSteps", "2", CVAR_ARCHIVE ); //latch because framebuffer sizes need to be changed (QTZTODO: runtime framebuffer recreation?)
	r_postprocess_bloomBlurStyle		= ri.Cvar_Get( "r_postprocess_bloomBlurStyle", "2", CVAR_ARCHIVE );
	r_postprocess_finalPass				= ri.Cvar_Get( "r_postprocess_finalPass", "0", CVAR_ARCHIVE );
	r_postprocess_userVec1				= ri.Cvar_Get( "r_postprocess_userVec1", "0.243137 0.298039 0.452941 0.2", CVAR_ARCHIVE );
	r_postprocess_debugFBOs				= ri.Cvar_Get( "r_postprocess_debugFBOs", "0", CVAR_ARCHIVE );
	//~QtZ
