...
void RB_BeginDrawingView( void ) {
	...
	if ( backEnd.viewParms.isPortal ) {
		...
		plane2[0] = DotProduct (&backEnd.viewParms.or.axis[0], (vector3 *)&plane[0]);
		plane2[1] = DotProduct (&backEnd.viewParms.or.axis[1], (vector3 *)&plane[0]);
		plane2[2] = DotProduct (&backEnd.viewParms.or.axis[2], (vector3 *)&plane[0]);
