	...
	while ( 1 )
	{
		...
		else if ( !Q_stricmp( token, "rgbGen" ) )
		{
			...
			else if ( !Q_stricmp( token, "const" ) )
			{
				...
				stage->constantColor[0] = (byte)(255 * color.x);
				stage->constantColor[1] = (byte)(255 * color.y);
				stage->constantColor[2] = (byte)(255 * color.z);
...
// Positions the most recently created shader in the tr.sortedShaders[] array so that the shader->sort key is sorted
//	relative to the other shaders.
