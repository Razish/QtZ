...
XCVAR_DEF( com_cameraMode,					"0",					NULL,					CVAR_CHEAT,					NULL )
...
XCVAR_DEF( pm_fixed,						"0",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_frametime,					"8",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_snapVec,						"0",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_overbounce,					"0",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_landAccelerateEnable,			"1",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_rampJumpEnable,				"1",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_wallJumpEnable,				"1",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_wallJumpDebounce,				"900",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_bunnyHopEnable,				"1",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_bunnyHopDebounce,				"250",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_doubleJumpEnable,				"1",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_doubleJumpPush,				"130",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_doubleJumpDebounce,			"300",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_accelerate,					"12.0",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_airaccelerate,				"0.75",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_friction,						"10.0",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_jumpVelocity,					"250.0",				NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_airControlEnable,				"1",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_airControl,					"100.0",				NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_airControlStopAccelerate,		"2.5",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_airControlWishspeed,			"15",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
XCVAR_DEF( pm_airControlStrafeAccelerate,	"100",					NULL,					CVAR_SYSTEMINFO|CVAR_ROM,			NULL )
