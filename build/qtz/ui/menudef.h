...
#define FEEDER_REDTEAM_LIST		 5	// red team members
#define FEEDER_BLUETEAM_LIST	 6	// blue team members
#define FEEDER_PLAYER_LIST		 7	// players
#define FEEDER_TEAM_LIST		 8	// team members for team voting
#define FEEDER_MODS				 9	// team members for team voting
#define FEEDER_DEMOS			10	// team members for team voting
#define FEEDER_SCOREBOARD		11	// team members for team voting
#define FEEDER_Q3HEADS			12	// model heads
#define FEEDER_SERVERSTATUS		13	// server status
#define FEEDER_FINDPLAYER		14	// find player

// display flags
#define CG_SHOW_BLUE_TEAM_HAS_REDFLAG	0x00000001u
#define CG_SHOW_RED_TEAM_HAS_BLUEFLAG	0x00000002u
#define CG_SHOW_ANYTEAMGAME				0x00000004u
#define CG_SHOW_TROJAN					0x00000008u
#define CG_SHOW_FLAGS					0x00000010u
#define CG_SHOW_HEALTHCRITICAL			0x00000020u
#define CG_SHOW_TOURNAMENT				0x00000040u
#define CG_SHOW_DURINGINCOMINGVOICE		0x00000080u
#define CG_SHOW_IF_PLAYER_HAS_FLAG		0x00000100u
#define CG_SHOW_LANPLAYONLY				0x00000200u
#define CG_SHOW_MINED					0x00000400u
#define CG_SHOW_HEALTHOK				0x00000800u
#define CG_SHOW_TEAMINFO				0x00001000u
#define CG_SHOW_NOTEAMINFO				0x00002000u
#define CG_SHOW_OTHERTEAMHASFLAG		0x00004000u
#define CG_SHOW_YOURTEAMHASENEMYFLAG	0x00008000u
#define CG_SHOW_ANYNONTEAMGAME			0x00010000u
#define CG_SHOW_2DONLY					0x00020000u
#define CG_SHOW_UNUSED14				0x00040000u
#define CG_SHOW_UNUSED13				0x00080000u
#define CG_SHOW_UNUSED12				0x00100000u
#define CG_SHOW_UNUSED11				0x00200000u
#define CG_SHOW_UNUSED10				0x00400000u
#define CG_SHOW_UNUSED09				0x00800000u
#define CG_SHOW_UNUSED08				0x01000000u
#define CG_SHOW_UNUSED07				0x02000000u
#define CG_SHOW_UNUSED06				0x04000000u
#define CG_SHOW_UNUSED05				0x08000000u
#define CG_SHOW_UNUSED04				0x10000000u
#define CG_SHOW_UNUSED03				0x20000000u
#define CG_SHOW_UNUSED02				0x40000000u
#define CG_SHOW_UNUSED01				0x80000000u

#define UI_SHOW_FAVORITESERVERS		0x00000001u
#define UI_SHOW_ANYNONTEAMGAME		0x00000002u
#define UI_SHOW_ANYTEAMGAME			0x00000004u
#define UI_SHOW_NEWHIGHSCORE		0x00000008u
#define UI_SHOW_DEMOAVAILABLE		0x00000010u
#define UI_SHOW_NEWBESTTIME			0x00000020u
#define UI_SHOW_FFA					0x00000040u
#define UI_SHOW_NOTFFA				0x00000080u
#define UI_SHOW_NOTFAVORITESERVERS	0x00000100u
